...
//13.............
	...
	Predicate predicateDateConditionLesserThan = criteriaBuilder.and();
	Predicate predicateDateConditionGreaterThan = criteriaBuilder.and();
	...
	predicateDateCondition = criteriaBuilder.equal(rootEntity.get("createdDate"), onDate);

	if (predicateDateCondition == null) {
	    predicateDateConditionGreaterThan = criteriaBuilder.greaterThan(rootEntity.get("fromDate"), onDate);
	    predicateDateConditionLesserThan = criteriaBuilder.lessThan(rootEntity.get("toDate"), onDate);
	    predicateSearchText = criteriaBuilder.and(predicateDateConditionLesserThan,
		    predicateDateConditionGreaterThan);
